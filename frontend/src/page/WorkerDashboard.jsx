...
const LargeCard = ({ title, children, action }) => (
  <div className="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6 shadow-sm">
    <div className="flex justify-between items-start mb-4">
      ...
      {action && (
        <div className="text-sm text-[#F97316] dark:text-[#EA580C] cursor-pointer">
          {action}
        </div>
      )}
    </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-900 p-8">
      <div className="max-w-[1200px] mx-auto bg-transparent">
        ...
        <div className="flex gap-6">
          {/* Sidebar */}
          <aside className="w-64 bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <nav className="space-y-2 text-zinc-700 dark:text-zinc-100">
                <Link
                  to="/worker"
                  className="flex items-center gap-3 px-2 py-2 rounded hover:bg-zinc-50 dark:hover:bg-zinc-700"
                >
