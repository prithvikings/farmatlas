  ...
  return (
    ...
    >
      ...
      <AccordionItem value="getting-started" className="py-2">
        <AccordionTrigger className="w-full py-0.5 text-left text-zinc-950 dark:text-zinc-50 selection:bg-[#EA580C] selection:text-zinc-100">
          <div className="flex items-center">
            ...
            <div className="ml-2 font-poppins ">
              How do I get started with FarmAtlas?
            </div>
          </div>
        </AccordionTrigger>
        <AccordionContent className="origin-left">
          <p className="pl-6 pr-2 text-zinc-500 dark:text-zinc-400 selection:bg-[#EA580C] selection:text-zinc-100 font-roboto tracking-wide text-sm">
      ...
      <AccordionItem value="roles-permissions" className="py-2">
        ...
        <AccordionContent className="origin-left">
          <p className="pl-6 pr-2 text-zinc-500 dark:text-zinc-400 font-roboto tracking-wide text-sm">
            You control who sees what. Workers can log feed and usage data. Vets
            can update health records. Only the farm owner or admin can manage
            finances and settings. No unwanted access, no risk.
          </p>
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="profitability-tracking" className="py-2">
        <AccordionTrigger className="w-full py-0.5 text-left text-zinc-950 dark:text-zinc-50 selection:bg-[#EA580C] selection:text-zinc-100">
          <div className="flex items-center">
            <ChevronRight className="h-4 w-4 text-zinc-950 transition-transform duration-200 group-data-expanded:rotate-90 dark:text-zinc-50" />
            <div className="ml-2 font-poppins">
              How does FarmAtlas help me see profits?
            </div>
          </div>
        </AccordionTrigger>
        <AccordionContent className="origin-left">
          <p className="pl-6 pr-2 text-zinc-500 dark:text-zinc-400 selection:bg-[#EA580C] selection:text-zinc-100 font-roboto tracking-wide text-sm">
            ...
            per category, or for your entire farm. No accounting skills
            required. Just clear insights into what’s earning and what’s
            draining money.
          </p>
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="support" className="py-2">
        ...
        <AccordionContent className="origin-left">
          <p className="pl-6 pr-2 text-zinc-500 dark:text-zinc-400 selection:bg-[#EA580C] selection:text-zinc-100 font-roboto tracking-wide text-sm">
            You can reach FarmAtlas support directly from your dashboard. We
            also provide guides, quick-start tutorials, and a community channel
            where farmers share tips, workflow ideas, and real-world solutions.
          </p>
        </AccordionContent>
      </AccordionItem>
    </Accordion>
