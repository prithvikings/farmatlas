    ...
    <div className="relative mx-auto flex w-full max-w-4xl flex-col justify-between gap-y-6 border-y bg-[radial-gradient(35%_80%_at_25%_0%,--theme(--color-foreground/.08),transparent)] px-4 py-8">
      ...
      <div className="space-y-1">
        <h2 className="text-center font-poppins text-2xl">
          Ready to upgrade your farm's operating system?
        </h2>
      ...
      <div className="flex items-center justify-center gap-2">
        ...
        <Button
          className="rounded-md bg-gradient-to-b from-[#EA580C] via-[#ec7d2d] to-[#e77f34] px-4 py-1.5 text-white shadow-xl active:scale-95 font-poppins transition duration-300 cursor-pointer"
